...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 23 15:55:03 2017
...
def MarketReturn(path):
    ...
    if dataDF_HS300[dataDF_HS300.isnull().values].size != 0:  # fillna
        ...
        dataDF_HS300.fillna(method='bfill', inplace=True)        # may be not correct!!!!
...
colLis = Return_HS300_3145_2009_to_3000.columns.tolist()
colArr = np.zeros((1, len(colLis)), dtype=object)
for i, j in enumerate(colLis):
    colArr[0][i] = np.array([j])

dataDic = {'colNames': colArr, \
           'indexTime': Return_HS300_3145_2009_to_3000[colLis[0]].values.reshape(len(Return_HS300_3145_2009_to_3000[colLis[0]].values), 1), \
           'Return_HS300_3145_2005_to_3000': Return_HS300_3145_2009_to_3000[colLis[1:]].values}
sio.savemat('/home/liushuanglong/MyFiles/Data/Factors/HLZ/Common/Financial/Return_HS300_3145_2005_to_3000_array.mat', dataDic)
